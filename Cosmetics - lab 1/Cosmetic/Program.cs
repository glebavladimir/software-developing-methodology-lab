...
namespace Cosmetic_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cosmetics.AddRange(CosmeticsDataFiller.GetCosmetics());
            string selector;
            do
            {
                ...
                {
                    case "1":
                        FindCosmeticByServiceType(cosmetics);
                        break;
                    case "2":
                        cosmetics.Add(FillCosmetic());
                        break;
                    case "3":
                        ShowAllCosmetics(cosmetics);
                        break;
                    case "4":
                        ViewCosmeticsToOrder(cosmetics);
                        break;
